				...
				<div class="card">
					<div class="card-header">
						<div class="card-title d-flex justify-content-center gap-3 mb-0">
							<h6>
								<i class="text-{{ $company->is_email_verify == 1 ? 'success' : 'danger' }}"
								data-feather="{{ $company->is_email_verify == 1 ? 'check-circle' : 'x-circle' }}"
								style="height: 16px;"></i>
								Email
							</h6>
							<h6>
								<i class="text-{{ $company->is_mobile_verify == 1 ? 'success' : 'danger' }}"
								data-feather="{{ $company->is_mobile_verify == 1 ? 'check-circle' : 'x-circle' }}"
								style="height: 16px;"></i>
								Mobile
							</h6>
							<h6>
								<i class="text-{{ $company->is_kyc_verify == 1 ? 'success' : 'danger' }}"
								data-feather="{{ $company->is_kyc_verify == 1 ? 'check-circle' : 'x-circle' }}"
								style="height: 16px;"></i>
								KYC
							</h6>
						</div>
					...
					<div class="card-body text-center">
						...
						<img src="{{ url('storage/profile', $company->profile_image) }}" id="profileImagePreview"
						alt="{{ $company->first_name }}" class="account-holder-image"
						style="max-width: 100%; width:90%; width:125px;aspect-ratio: 1/1;">
						@else
						<img src="{{ url('admin/default-profile.png') }}" id="profileImagePreview"
						alt="{{ $company->first_name }}"
						class="account-holder-image"style="max-width: 100%; width:90%; width:125px;aspect-ratio: 1/1;">
						@endif
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						<div class="list-group list-group-flush">
							...
							class="list-group-item d-flex justify-content-between flex-column flex-wrap border-0 px-0">
								...
								<h6>{{ $company->companyDetail && $company->companyDetail->businessTypes ? $company->companyDetail->businessTypes->business_type : 'N/A' }}
								</h6>
							</div>
							...
							class="list-group-item d-flex justify-content-between flex-column flex-wrap border-0 px-0">
								...
								<h6>{{ $company->companyDetail ? $company->companyDetail->no_of_director : 1 }}
								</h6>
							</div>
