<div class="modal fade" id="editLiveRateModal" tabindex="-1" aria-labelledby="varyingModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="editLiveRateForm" action="{{ route('admin.merchant.exchange-rate.update', ['id' => $liverate->id]) }}" method="post" enctype="multipart/form-data">
				<input type="hidden" name="user_id" id="user_id" value="{{ $userId }}">
				<div class="modal-body">
					<div class="mb-3">
						<label for="recipient-name" class="form-label">Aggregator Charge <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="aggregator_rate" name="aggregator_rate" value="{{ $liverate->aggregator_rate }}" placeholder="Aggregator Charge"> 
					</div> 
					<div class="mb-3">
