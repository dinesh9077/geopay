	...
	<div class="row g-4">
		...
		<div class="col-lg-9 mb-3 add-money-section">
			<ul class="nav nav-pills mb-4 w-100" id="pills-tab" role="tablist">
				...
				<li class="nav-item col-12 col-md-4" role="presentation">
					<button class="nav-link px-4 w-100 active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Mobile Money</button>
				</li>
				{{-- <li class="nav-item col-12 col-md-4" role="presentation">
