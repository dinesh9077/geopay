...
<table style="text-align: start;"  class="text-uppercase">
	...
	@elseif($transaction->platform_name == "international airtime")
		...
		<tr><th class="content-4 d-flex justify-content-between text-nowrap">OPERATOR NAME <span class="mx-1">:</span></th><td class="content-4">{{ $transaction->apiResponseAsArray ? ($transaction->apiResponseAsArray['product']['operator']['name'] ?? "N/A") : 'N/A'}}</td></tr> 
