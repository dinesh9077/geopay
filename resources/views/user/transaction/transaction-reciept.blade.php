        ...
        <tr>
			...
			<td class="content-4">
				{{ isset($transaction->beneficiary_request['data']['receiverfirstname']) && isset($transaction->beneficiary_request['data']['receiverlastname']) ? 
					$transaction->beneficiary_request['data']['receiverfirstname'] . ' ' . $transaction->beneficiary_request['data']['receiverlastname'] : 'N/A' }}
			</td>
		</tr> 
        <tr>
            <th class="content-4 d-flex justify-content-between text-nowrap">Mobile <span class="mx-1">:</span></th>
            <td class="content-4">{{ $transaction->beneficiary_request['data']['receivercontactnumber'] ?? 'N/A' }}</td>
        </tr> 
        <tr>
			<th class="content-4 d-flex justify-content-between text-nowrap">UNIT AMOUNT <span class="mx-1">:</span></th>
			<td class="content-4">{{ $transaction->unit_rates}}</td>
