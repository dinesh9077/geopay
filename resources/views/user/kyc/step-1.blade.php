<div class="row"> 
	...
	<div class="col-md-6 mb-3">
		...
		<input type="text" class="form-control bg-light border-light" id="no_of_director" name="no_of_director" value="{{ $companyDetail ? $companyDetail->no_of_director : 1 }}" {{ isset($companyDetail) && $companyDetail->is_director == 0 ? 'readonly' : '' }} > 
	</div> 
	<div class="col-md-6 mb-3">
