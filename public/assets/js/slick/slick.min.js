        ...
        function c(c, d) {
            ...
            if (
                ((e.defaults = {
                    ...
                    asNavFor: null,
                    prevArrow:
                        '<button type="button" data-role="none" class="slick-prev btn btn-light shadow-lg rounded-circle"><i class="bi bi-chevron-left"></i></button>',
                    nextArrow:
                        '<button type="button" data-role="none" class="slick-next btn btn-light shadow-lg rounded-circle"><i class="bi bi-chevron-right"></i></button>',
                    autoplay: !1,
                    autoplaySpeed: 3e3,
                    centerMode: !1,
                    centerPadding: "50px",
