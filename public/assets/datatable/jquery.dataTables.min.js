    ...
    var S = function (h) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    z(
                        ...
                        "aoDrawCallback",
                        function () {
                            (o.bSorted || y(o) === "ssp" || v.bDeferRender) &&
                                xa(o);
                        },
                        "sc"
                    );
                    ...
                    0 === i.length || 0 === i.children().length
                        ...
                        : 0 < i.length &&
                          ((o.nTFoot = i[0]), fa(o.aoFooter, o.nTFoot));
                    if (e.aaData)
        ...
        t.register = p = function (a, b) {
            if (h.isArray(a))
                ...
                for (
                    ...
                    j ||
                        ((j = { name: g, val: {}, methodExt: [], propExt: [] }),
                        f.push(j));
                    c === d - 1
                        ? (j.val = b)
        ...
        var Za = function (a, b, c, d, e) {
                ...
                for (n = b.length; j < n; j++) {
                    ...
                    for (m = i.length; l < m; l++)
                        (g = c(
                            "string" === typeof i[l] ? h.trim(i[l]) : i[l]
                        )) &&
                            g.length &&
                            (f = f.concat(g));
                }
        ...
        p("destroy()", function (a) {
            ...
            return this.iterator("table", function (b) {
                ...
                e != g.parentNode &&
                    (j.children("thead").detach(), j.append(g));
                i &&
                    e != i.parentNode &&
