...
class CheckKycStatus
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if (Auth::check() && (Auth::user()->is_kyc_verify !== 1)) {
            ...
            $routesArr = $is_company == 1 ? ['corporate.kyc', 'corporate.kyc.submit-step', 'corporate.kyc.submit-final', 'corporate.kyc.document-store', 'corporate.kyc.document-type', 'corporate.kyc.director'] : ['metamap.kyc', 'metamap.kyc-finished', 'metamap.kyc-check-status'];
