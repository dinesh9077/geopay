<?php
	...
	Route::middleware(['auth:admin', 'webdecrypt.request'])->as('admin.')->group(function ()
	{
		...
		Route::post('/third-party-key/onafric-bank-status-update', [SettingController::class, 'thirdPartyKeyOnafricBankStatusUpdate'])->name('third-party-key.onafric-bank-status-update')->withoutMiddleware('webdecrypt.request');
		...
		//Merchat/Partner
		Route::get('/merchant/index', [MerchantController::class, 'index'])->name('merchant.index')->middleware('permission:marchant.view');
		Route::post('/merchant/ajax', [MerchantController::class, 'merchantAjax'])->withoutMiddleware('webdecrypt.request')->name('merchant.ajax');
		Route::get('/merchant/create', [MerchantController::class, 'merchantCreate'])->name('merchant.create');
		Route::post('/merchant/store', [MerchantController::class, 'merchantStore'])->name('merchant.store');
		Route::get('/merchant/edit/{id}', [MerchantController::class, 'merchantEdit'])->name('merchant.edit');
		Route::post('/merchant/update/{id}', [MerchantController::class, 'merchantUpdate'])->name('merchant.update');
		Route::post('/merchant/delete/{id}', [MerchantController::class, 'merchantDelete'])->withoutMiddleware('webdecrypt.request')->name('merchant.delete');
		
		//Add Fund
		Route::get('/merchant/fund', [MerchantController::class, 'merchantFund'])->name('merchant.fund')->middleware('permission:merchant_fund.view');
		Route::post('/merchant/fund/ajax', [MerchantController::class, 'merchantFundAjax'])->withoutMiddleware('webdecrypt.request')->name('merchant.fund.ajax');
		Route::post('/merchant/fund/store', [MerchantController::class, 'merchantFundStore'])->withoutMiddleware('webdecrypt.request')->name('merchant.fund.store');
		Route::post('/merchant/fund/delete/{id}', [MerchantController::class, 'merchantFundDelete'])->withoutMiddleware('webdecrypt.request')->name('merchant.fund.delete');
		
		//Ip Whitelist
		Route::get('/merchant/ipwhitelist', [MerchantController::class, 'merchantIpWhitelist'])->name('merchant.ipwhitelist')->middleware('permission:merchant_ip_whitelist.view');
		Route::post('/merchant/ipwhitelist/ajax', [MerchantController::class, 'merchantIpWhitelistAjax'])->withoutMiddleware('webdecrypt.request')->name('merchant.ipwhitelist.ajax'); 
		Route::post('/merchant/ipwhitelist/store', [MerchantController::class, 'merchantIpWhitelistStore'])->withoutMiddleware('webdecrypt.request')->name('merchant.ipwhitelist.store');
		Route::post('/merchant/ipwhitelist/delete/{id}', [MerchantController::class, 'merchantIpWhitelistDelete'])->withoutMiddleware('webdecrypt.request')->name('merchant.ipwhitelist.delete');
		
		//Api Activation
		Route::get('/merchant/api-activation/{id}', [MerchantController::class, 'merchantApiActivation'])->name('merchant.api-activation')->middleware('permission:api_activate_deactive.view');
		Route::post('/merchant/api-activation/generate', [MerchantController::class, 'merchantApiActivationGenerate'])->withoutMiddleware('webdecrypt.request')->name('merchant.api-activation.generate'); 
		
		//Api Activation
		Route::get('/merchant/commission/{id}', [MerchantController::class, 'merchantCommission'])->name('merchant.commission')->middleware('permission:merchant_commission.view');
		Route::post('/merchant/commission/store', [MerchantController::class, 'merchantCommissionStore'])->withoutMiddleware('webdecrypt.request')->name('merchant.commission.store'); 
		
		//FX rate
		Route::get('/merchant/exchange-rate', [MerchantController::class, 'merchantExchangeRate'])->name('merchant.exchange-rate')->middleware('permission:merchant_exchange_rate.view');
		Route::post('/merchant/exchange-rate/ajax', [MerchantController::class, 'merchantExchangeRateAjax'])->withoutMiddleware('webdecrypt.request')->name('merchant.exchange-rate.ajax'); 
		Route::post('/merchant/exchange-rate/bulk-update', [MerchantController::class, 'merchantExchangeRateBulkUpdate'])->name('merchant.exchange-rate.bulk-update');
		Route::get('/merchant/exchange-rate/edit/{id}', [MerchantController::class, 'merchantExchangeRateEdit'])->name('merchant.exchange-rate.edit');
		Route::post('/merchant/exchange-rate/update/{id}', [MerchantController::class, 'merchantExchangeRateUpdate'])->name('merchant.exchange-rate.update');
		
		 
		Route::post('/merchant/exchange-rate/manual-ajax', [MerchantController::class, 'merchantExchangeRateManualAjax'])->withoutMiddleware('webdecrypt.request')->name('merchant.exchange-rate.manual-ajax'); 
		Route::post('/merchant/exchange-rate/bulk-manual-update', [MerchantController::class, 'merchantExchangeRateBulkManualUpdate'])->name('merchant.exchange-rate.bulk-manual-update');
		Route::get('/merchant/exchange-rate/manual-edit/{id}', [MerchantController::class, 'merchantExchangeRateManualEdit'])->name('merchant.exchange-rate.manual-edit');
		Route::post('/merchant/exchange-rate/manual-update/{id}', [MerchantController::class, 'merchantExchangeRateManualUpdate'])->name('merchant.exchange-rate.manual-update');
		  
		//Transaction Limit
		Route::get('/merchant/transaction-limit/{id}', [MerchantController::class, 'merchantTransactionLimit'])->name('merchant.transaction-limit')->middleware('permission:merchant_daily_transaction_limit.view');
		Route::post('/merchant/transaction-limit/store', [MerchantController::class, 'merchantTransactionLimitStore'])->withoutMiddleware('webdecrypt.request')->name('merchant.transaction-limit.store'); 
