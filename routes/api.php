<?php
	...
	*/
	...
	{  
		...
		Route::post('/user-kyc/verify', [UserKycController::class, 'verify'])->withoutMiddleware('decrypt.request');
		Route::post('/user-kyc-cron', [UserKYCController::class, 'getKYCVerification'])->withoutMiddleware('decrypt.request');
	});
